class Middle0Line:
    ...
    ssl = 0
    svl = 0
    middle0_lines_dict = {'Нижняя линия': 'МИНИМУМ', 'Средняя линия': 'СРЕДНЕ', 'Верхняя линия': 'МАКСИМУМ', 'Выпал 0': 'НОЛЬ'}
    ...
    def middle0_bets_in_line(self, c_snl, c_ssl, c_svl):
        ...
        self.dict['min'] = self.middle0_lines_bet_dict[self.middle0_lines_dict['Нижняя линия']]
        self.dict['middle'] = self.middle0_lines_bet_dict[self.middle0_lines_dict['Средняя линия']]
        self.dict['max'] = self.middle0_lines_bet_dict[self.middle0_lines_dict['Верхняя линия']]
